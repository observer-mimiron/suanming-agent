...
const (
	...
	// BoundaryCollectBirthplaceFromProfile 用于“已拿到出生年月日时和性别，但缺出生地”的确定性追问。
	BoundaryCollectBirthplaceFromProfile BoundaryPrompt = "collect_birthplace_from_profile"
...
func renderBoundary(boundary BoundaryPrompt, ctx Context) string {
	...
	case BoundaryCollectBirthplaceFromProfile:
		return "已经收到您的出生年月日时和性别，还差一个关键信息：出生地。请告诉我出生城市或地区，我再继续为您排盘分析。"
