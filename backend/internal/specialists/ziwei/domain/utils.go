// 本文件属于紫微 domain 层。
// 本文件负责循环索引、时辰、亮度、四化和小限索引等纯领域辅助函数。
// 不负责 lunar-go、工具参数、Session、模型、trace、SSE 或最终文本。
package domain
...
// BranchIndex 将地支名称转换为自然序数索引。子=0、丑=1、寅=2、...、亥=11。
...
// StemIndex 将天干名称转换为序数索引。甲=0、乙=1、丙=2、...、癸=9。
