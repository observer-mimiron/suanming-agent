...
type SessionState struct {
	...
	ManagerContext ManagerContext              `json:"manager_context,omitempty"`
	DomainContexts LayeredDomainContexts       `json:"domain_contexts,omitempty"`
...
func (s *SessionState) Clone() *SessionState {
	...
	if len(s.Execution.SecondaryDomains) > 0 {
		clone.Execution.SecondaryDomains = append([]string(nil), s.Execution.SecondaryDomains...)
	}
	if len(s.Execution.Domains) > 0 {
		clone.Execution.Domains = append([]string(nil), s.Execution.Domains...)
	}
	if len(s.Execution.RequiredArtifacts) > 0 {
		clone.Execution.RequiredArtifacts = append([]string(nil), s.Execution.RequiredArtifacts...)
	}
	if len(s.Execution.Gate.AllowedDomains) > 0 {
		clone.Execution.Gate.AllowedDomains = append([]string(nil), s.Execution.Gate.AllowedDomains...)
	}
	if s.Profile != nil {
