...
// ---------------------------------------------------------------------------
// Agent profiles — Phase 4 agent identity as knowledge pages
// ---------------------------------------------------------------------------

/** An agent registered in knowledge. */
export interface AgentProfile {
  /** Unique agent identifier. For owned agents this is the composite
   *  `slugify("<owner>-<name>")` (e.g. "knowledge-yoyo", "alice-yoyo"), so every
   ...
   *  for a root agent (the synced base, e.g. "knowledge-yoyo"). A fork inherits
