...
import { detectEnvProvider, loadConfigSync, getEmbeddingModelOverride, getOllamaBaseUrl, getEmbeddingBaseUrl } from "./config";
...
function resolveEmbeddingProvider(
  ...
  // EMBEDDING_API_KEY: standalone embedding provider
  if (process.env.EMBEDDING_API_KEY) return "openai";
