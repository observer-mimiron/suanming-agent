/**
 * knowledge logomark — a small node-constellation glyph that ties the brand to
...
interface LogoProps {
  ...
  size?: number;
  /** Hide the "knowledge" wordmark, showing only the glyph. */
  markOnly?: boolean;
}

/** Logomark + "knowledge" wordmark, for the nav and footer. */
